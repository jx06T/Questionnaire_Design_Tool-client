...
export async function listAllDemoQuestionnaires() {
    try {
        const config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: SERVER_URL + "listAllDemoQuestionnaires",
            headers: {
                'Content-Type': 'application/json',
            },
        };
...
export async function getDemoQuestionnaireById(id) {
    try {
        const data = JSON.stringify({ id: id });
        ...
        const config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: SERVER_URL + "getDemoQuestionnaireById",
            headers: {
                'Content-Type': 'application/json',
            },
            data: data
